(() => {
  const products = [
    { name: 'זר פאוניה בזריחה', blurb: 'פאוניות ורודות, רנונקולוס ונענע גינה.', price: 48, onSale: true, salePrice: 36, img: 'images/product-1.jpg', categories: ['פרחים', 'משלוחי פרחים באשדוד', 'יום אהבה'] },
    { name: 'תערובת פרחי בר', blurb: 'פרחי שדה חופשיים, לפי מה שפורח השבוע.', price: 38, onSale: false, img: 'images/product-2.jpg', categories: ['פרחים', 'משלוחי פרחים באשדוד', 'דילים חמים'] },
    { name: 'זר ורדים בגוון טרקוטה', blurb: 'ורדי גינה בגוונים חמים, עם אקליפטוס.', price: 56, onSale: true, salePrice: 45, img: 'images/product-3.jpg', categories: ['פרחים', 'משלוחי פרחים באשדוד', 'יום אהבה', 'דילים חמים'] },
    ...
    return `
      <div class="reveal in-view">
        <div class="card elev-sm hover-lift" style="padding:0;overflow:hidden;position:relative;">
          <div class="washed" style="border-radius:32px 32px 0 0;overflow:hidden;position:relative;aspect-ratio:4/3;">
